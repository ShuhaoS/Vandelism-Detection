...
trainfile = codecs.open('../../data/sklearn/Intermediates/wdvc16_train.csv','w','utf8')
trainwriter = csv.writer(trainfile)
valfile = codecs.open('../../data/sklearn/Intermediates/wdvc16_validation.csv','w','utf8')
valwriter = csv.writer(valfile)

# Directories for writing to files
train_dir = glob('../../data/sklearn/Train/')
validation_dir = glob('../../data/sklearn/Validation/')
...
def join_csv_files(whichSet):
	...
	#Train
	if whichSet == 0:
		features_file = '../../data/sklearn/Intermediates/wdvc16_train.csv'
		meta_file = '../../data/sklearn/Train/wdvc16_meta.csv'
		truth_file = '../../data/sklearn/Train/wdvc16_truth.csv'
		joined_file = '../../data/sklearn/Train/wdvc16_train.csv'


	#Validation
	elif whichSet == 1:
		features_file = '../../data/sklearn/Intermediates/wdvc16_validation.csv'
		meta_file = '../../data/sklearn/Validation/wdvc16_2016_03_meta.csv'
		truth_file = '../../data/sklearn/Validation/wdvc16_2016_03_truth.csv'
		joined_file = '../../data/sklearn/Validation/wdvc16_validation.csv'
...
def main():
	...
	#Train:
	train_files = glob('../../data/sklearn/Train/*.xml')
	...
	#TODO: test
	#Validation:
	val_files = glob('../../data/sklearn/Validation/*.xml')
