...
#reading the data
df_train = pd.read_csv('../../data/sklearn/Train/wdvc16_train.csv', dtype={'REVISION_ID': object, \
...
df_validation = pd.read_csv('../../data/sklearn/Validation/wdvc16_validation.csv', dtype={'REVISION_ID': object, \
	'PAGE_TITLE': object, 'USER_NAME': object, 'USER_ID': object, \
	'USER_IP': object, 'REVISION_SESSION_ID': object, 'USER_COUNTRY_CODE': object, \
	'USER_CONTINENT_CODE': object, 'USER_TIME_ZONE': object, 'USER_REGION_CODE': object, \
	'USER_CITY_NAME': object, 'USER_COUNTY_NAME': object, 'REVISION_TAGS': object, \
...
print ('SVC-linear-ker: Time used: %.2fs, ROC_AUC=%.6f, ACCURACY=%.6f' % (time() - t,roc_score,acc_score))
