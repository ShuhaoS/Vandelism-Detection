...
trainfile = codecs.open('../../data/tensorflow/Intermediates/wdvc16_train.csv','w','utf8')
trainwriter = csv.writer(trainfile)
valfile = codecs.open('../../data/tensorflow/Intermediates/wdvc16_validation.csv','w','utf8')
valwriter = csv.writer(valfile)
testfile = codecs.open('../../data/tensorflow/Intermediates/wdvc16_test.csv','w','utf8')
...
train_dir = glob('../../data/tensorflow/Train/')
validation_dir = glob('../../data/tensorflow/Validation/')
test_dir = glob('../../data/tensorflow/Test/')
...
def join_csv_files(whichSet):
	...
	#Train
	if whichSet == 0:
		features_file = '../../data/tensorflow/Intermediates/wdvc16_train.csv'
		meta_file = '../../data/tensorflow/Train/wdvc16_meta.csv'
		truth_file = './Train/wdvc16_truth.csv'
		joined_file = '../../data/tensorflow/Train/wdvc16_train.csv'


	#Validation
	elif whichSet == 1:
		features_file = '../../data/tensorflow/Intermediates/wdvc16_validation.csv'
		meta_file = '../../data/tensorflow/Validation/wdvc16_2016_03_meta.csv'
		truth_file = '../../data/tensorflow/Validation/wdvc16_2016_03_truth.csv'
		joined_file = '../../data/tensorflow/Validation/wdvc16_validation.csv'

	#Test
	else: #whichSet == 2
		features_file = '../../data/tensorflow/Intermediates/wdvc16_test.csv'
		meta_file = '../../data/tensorflow/Test/wdvc16_2016_05_meta.csv'
		truth_file = '../../data/tensorflow/Test/wdvc16_2016_05_truth.csv'
		joined_file = '../../data/tensorflow/Test/wdvc16_test.csv'
		...
		with codecs.open(meta_file, 'r', 'utf8') as metafile:
			with codecs.open(truth_file, 'r', 'utf8') as truthfile:
				with codecs.open(joined_file, 'w', 'utf8') as joinedfile:
					next(featuresfile) # skip header line
					next(metafile) # skip header line
					next(truthfile) # skip header line
					while True:
...
def main():
	...
	#Train:
	train_files = glob('../../data/tensorflow/Train/*.xml')
	...
	#Validation:
	val_files = glob('../../data/tensorflow/Validation/*.xml')
	...
	#testwriter.writerow(init_line)
	#for xml_doc in test_files:
		# first lets create the intermediate file 
		#print ('Processing file: %s...' % xml_doc)
		#parse_pages(xml_doc, 2)
	#valfile.flush()
	#join_csv_files(2)
