...
parser.add_argument(
    '--train_data', type=str, default='../../data/tensorflow/Train/wdvc16_train.csv',
    help='Path to the training data.')

parser.add_argument(
    '--test_data', type=str, default='../../data/tensorflow/Validation/wdvc16_validation.csv',
    help='Path to the test data.')


# Use pandas for useful information about csv file, such as how many rows and how many unique entries in a col
df = pandas.read_csv('../../data/tensorflow/Train/wdvc16_train.csv', names=_CSV_COLUMNS )
df2 = pandas.read_csv('../../data/tensorflow/Validation/wdvc16_validation.csv', names=_CSV_COLUMNS )
...
def input_fn(data_file, num_epochs, shuffle, batch_size):
  ...
  assert tf.gfile.Exists(data_file), (
      '%s not found. Please make sure you have gotten the correct data or '
